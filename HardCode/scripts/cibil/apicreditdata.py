    ...
    if file_found:
        try:
            ...
            if type(acc_details) is list:
                ...
                try:
                    age_of_oldest_trade = manipulatedate(str(int(latest_closed_date))) - manipulatedate(
                        str(oldest_date_of_open))
                    age_of_oldest_trade = age_of_oldest_trade.days
                except:
                    age_of_oldest_trade = manipulatedate(str(latest_date_of_open)) - manipulatedate(
                        str(oldest_date_of_open))
                    age_of_oldest_trade = age_of_oldest_trade.days
                ...
                for i in range(0, len(acc_details)):
                    ...
                    try:
                        SuitFiledWillfulDefaultWrittenOffStatus = acc_details[i][
