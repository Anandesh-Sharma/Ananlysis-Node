import pandas as pd
import datetime
from analysisnode.HardCode.scripts.cibil.xmlparser import xml_parser
...
with open("cibil_data_327251.xml") as f:
    df = convert_to_df(f)['data']
    df.to_csv("xml_csv_327251.csv")