from HardCode.scripts.model_0.parameters.deduction_parameters.reference_verification.data_extraction.data import \
    get_reference_details, get_contacts_data
from HardCode.scripts.model_0.parameters.deduction_parameters.reference_verification.validation.cosine_similarity_method import \
    cos_sim
