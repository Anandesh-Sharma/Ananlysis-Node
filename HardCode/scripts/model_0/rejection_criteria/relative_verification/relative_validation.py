from HardCode.scripts.model_0.rejection_criteria.relative_verification.rel_similarity import rel_cos_sim
from HardCode.scripts.model_0.rejection_criteria.reference_verification.data_extraction.data import get_contacts_data
