...
def get_loan_messages_promotional_removed(data, loan_messages):
    ...
    pattern_1 = 'kyc'
    pattern_2 = 'sbi\scard'
    pattern_3 = 'credited\sto\syour\swallet'
    pattern_4 = 'spice\smoney'
    pattern_5 = 'sign\sthe\selectronic\scontract'
    pattern_6 = 'golden\slightning'
    pattern_7 = 'gold\scash'
    pattern_8 = 'after\syour\sconfirmation'
    pattern_9 = 'your\spersonalised\sloan\soffer'
    pattern_10 = 'emi\scard|credit\scard'
    pattern_11 = '\se-?sign\s'
    pattern_12 = 'claim\sbonus'
    pattern_13 = 'icredit|rupeeplus'
    pattern_14 = 'good\snews'
    pattern_15 = 'confirm\snow'
...
def get_approval(data, loan_messages_filtered, result, name):
    ...
    selected_rows = []
    pattern_1 = 'successfully\sapproved'
    pattern_2 = 'has\sbeen\sapproved'
    pattern_3 = 'documents\shas\sbeen\ssuccessfully\sverified'
...
def get_disbursed(data, loan_messages_filtered, result, name):
    ...
    pattern_4 = 'disburse?ment.*has\sbeen\sinitiated'
    pattern_5 = 'is\stransferred.*account'
    pattern_6 = 'loan\sapplication.*?successfully\ssubmitted.*?bank'
    pattern_7 = 'you.*?received.*?loan\samount'
    pattern_8 = 'your.*?loan.*?made\ssuccessfully.*?loan\samount'
    pattern_9 = 'loan\srs.*?disbursed'
    pattern_10 = 'loan\shas\sbeen\sreleased\sto.*?bank'
    pattern_11 = 'rs.*?credited\sto\sloan\sa\/c'
    pattern_12 = 'disbursed.*?loan.*?to\syour\sbank'
    pattern_13 = 'amount\sfinanced\sfor\sloan.*?rs'
    pattern_14 = 'personal\sloan.*?transferred\ssuccessfully'
    pattern_15 = 'your\sloan\sdisbursement\swas\ssuccess'
    pattern_16 = 'loan.*?approved.*?cash.*?issued\sto.*?bank\saccount'
    pattern_17 = 'loan.*?approved.*?will\stransfer.*?funds.*bank\saccount'
    pattern_18 = 'loan.*approved.*fund[s]?\swill\sbe\stransferred.*bank\saccount'
    pattern_19 = 'loan.*approved.*disbursed\sinto\syour\saccount'
    pattern_20 = 'loan.*approved.*will\srelease.*loan\sto.*account'
    pattern_21 = 'loan.*approved.*sent\srs.*to\syour\saccount'
    pattern_22 = 'loan.*approved.*will\sbe\sdisbursed'
    pattern_23 = 'loan.*approved.*credit\sto.*?bank\saccount'
...
def get_loan_rejected_messages(data, loan_messages_filtered, result, name):
    ...
    pattern_1 = 'loan\sapplication.*?is\srejected'
    pattern_2 = 'loan\sapplication.*?got\srejected'
    pattern_3 = 'loan.*paysense\sis\srejected'
    pattern_4 = 'has\sbeen.*?rejected'
    pattern_5 = 'is\sdeclined'
    pattern_6 = 'has\sbeen\sdeclined'
    pattern_7 = 'has\snot\sbeen\sapproved'
    pattern_8 = 'was\snot\sapproved'
    pattern_9 = 'was\sbeen\srejected'
    pattern_10 = 'could\snot\sget\sapproved'
    pattern_11 = "sorry.*?couldn't.*?eligible.*?loan"
    pattern_12 = 'credit.*rejected.*loan.*application'
    pattern_13 = 'low\scibil\sscore'
    pattern_14 = 'low\scredit\sscore'
    pattern_15 = 'is\sdue'
    pattern_16 = 'network\scard'
...
def get_over_due(data, loan_messages_filtered, result, name):
    ...
    pattern_1 = 'immediate\spayment'
    pattern_2 = 'delinquent'
    pattern_3 = 'missed\spayments'
    pattern_4 = 'is\sdue'
    pattern_5 = 'is\soverdue'
    pattern_6 = 'loan\sis\sdue'
    pattern_7 = 'due\sdate'
    pattern_8 = 'due\shai'
    pattern_9 = 'overdue\shai'
    pattern_10 = '\sover-?due'
    pattern_11 = 'loan\sis\son\sdue'
    pattern_12 = 'emi\sof.*?was\sdue\son'
    pattern_13 = 'loan.*?emi\srs.*?due\son'
    pattern_14 = 'payment\sof.*?against.*?loan.*?bounced'
    pattern_15 = "you\sstill\shaven['o]t\spaid.*?loan"
    pattern_16 = 'you\shave\smissed.*?payment.*?loan'
    pattern_17 = 'loan\sof\srs.*?disbursed\sfrom.*?a\/c'
    pattern_18 = 'repay\syour\semi\samount\sdue\son'
    pattern_19 = 'loan.*?borrowed.*?will\sbe\sdue\son'
    pattern_20 = 'k[io]\sdey\shai'
    pattern_21 = 'pay.*?loan\sof\srs.*?by'
    pattern_22 = 'charges\sof\srs.*?in\syour\sloan'
    pattern_23 = 'your\srepayment\sdate.*?repayment\samount'
    pattern_24 = 'loan.*?bakaya\shai'
    pattern_25 = 'earlysalary.*?requested\spayment'
    pattern_26 = 'missed\syour\spayment\son.*?loan'
    pattern_27 = 'not\spaid\semi.*?against\syour\sloan'
    pattern_28 = 'emi.*?dhani\sloan\sis\sstill\sdue'
    pattern_29 = 'last\sday\sfor.*?loan\srepayment'
    pattern_30 = 'payment\sis\sdelayed\sby\sweeks'
    pattern_31 = 'do\snot\sforget\sto\spay.*?loan'
    pattern_32 = 'your\sloan\sis\sstill\sunpaid'
    pattern_33 = 'promised\sto\spay\srs.*?loan'
    pattern_34 = 'emi.*?will\sbe\s(auto-)?debited'
    pattern_35 = 'instalment\sis\sunpaid'
    pattern_36 = 'dues\sof\srs.*?outstanding.*?for\sloan'
    # overdue
