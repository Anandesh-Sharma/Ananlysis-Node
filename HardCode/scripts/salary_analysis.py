...
def cleaning(df):
	...
	cleaning_transaction_patterns = ['request received to','received a request to add','premium receipt','contribution',
	...
	'refund credited','return request','received request','documents have been received',
	'last day free','received a refund','will be processed shortly','credited a free',
	'request for modifying','free \d* [gm]b/day','data pack','request for registration',
	'received by our company','month of','received a call','free data','data benefits',
	'received full benefit','payment against','auto debited','mandates','We apologize for the incorrect SMS',
	'coupon','can be credited ','no hassle of adding beneficiary','you\'re covered',
	'bank will never ask you to','eAadhaar','great news!','your query has','redemption request','number received',
	'your order','beneficiary [a-z]*? is added successfully','dear employee','subscribing','sorry',
	'received \d*? enquiry','congratulations?','woohoo!','hurry',
	'sign up','credited to your wallet','safe & secure!','[gm]b is credited on','cash reward',
	'remaining emi installment','incentive amount ','dear investor',
	'verification code','outstanding dues','congrat(ulation)?s','available limit ','oyo money credited',
	'reminder','card ?((holder)|(member))','login request','cashback','electricity bill','data pack activation',
	'paytm postpaid bill','failed','declined','cardmember','credit ?card',' porting ','lenskart',
	'activated for fund transfer','biocon','updated wallet balance','recharging','assessment year','we wish to inform','refunded',
	'amendment','added/modified','kyc verification','is due','paytm postpaid','please pay','flight booking','offer',
	'(credited)?(received)? [0-9]*[gm]b','payment.*failed','uber india systems pvt ltd','has requested money','on approving',
	'not received','received your','brand factory has credited ','train ticket','total (amt)?(amount)? due','redbus wallet','otp',
	'due of','received ?a? ?bill','successful payments','response ','last day','payment confirmation','payment sms','kyc',
	'added beneficiary','received a message',' premium ','claim','points ','frequency monthly','received a pay rise','cheque book',
	'will be','unpaid','received (for|in) clearing','presented for clearing','your application','to know','unpaid',
