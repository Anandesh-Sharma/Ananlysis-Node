                        ...
                        while j < len(data):
                            ...
                            if is_due(msg_after_disbursal, app):
                                ...
                                if (due_date - disbursal_date).days < 16:
                                    ...
                                    individual_loan_details['loan_due_amount'] = float(
                                        due_amount_extract(msg_after_disbursal, app))
                                    k = j + 1
                                    while k < len(data):
                                        ...
                                        if is_overdue(msg_after_due, app):
                                            ...
                                            try:
                                                individual_loan_details['overdue_days'] = overdue_days_extract(
                                                    msg_after_due, app)
                                            except:
                                                pass
                                            ...
                                            while m < len(data):
                                                ...
                                                if is_closed(msg_after_overdue, app):
                                                    ...
                                                    closed_date = datetime.strptime(str(data['timestamp'][m]),
                                                                                    "%Y-%m-%d %H:%M:%S")
                                                    ...
                                                    individual_loan_details['loan_closed_amount'] = float(
                                                        closed_amount_extract(msg_after_overdue, app))
                                                    individual_loan_details['messages'].append(str(data['body'][m]))
                                                    k = m + 1
                                                    FLAG = True
                                                    logger.info("loan closed!")
                                                    break
                                                elif is_disbursed(msg_after_overdue, app) or is_due(msg_after_overdue,
                                                                                                    app):
                                                    logger.info(
                                                        "loan closed because before closing previous loan another disbursal message found")
                                                    k = m
                                                    FLAG = True
                                                    break
                                            ...
                                            logger.info("closed message found")
                                            closed_date = datetime.strptime(str(data['timestamp'][k]),
                                                                            "%Y-%m-%d %H:%M:%S")
                                            loan_duration = (disbursal_date - closed_date).days
                                            if loan_duration > 15:
                                                individual_loan_details['overdue_days'] = loan_duration - 15
                                            ...
                                            individual_loan_details['loan_closed_amount'] = float(
                                                closed_amount_extract(msg_after_due, app))
                                            individual_loan_details['messages'].append(str(data['body'][k]))
                                            FLAG = True
                                            j = k + 1
                                            logger.info("loan closed")
                                            ...
                                            if (due_date - disbursal_date).days <= 16:
                                                ...
                                                logger.info(
                                                    "loan closed because a due message found which is not belong to current loan")
                                                FLAG = True
                                                j = k
                                                break
                                        else:
                            ...
                            # ***********************************************************************************************
                                ...
                                logger.info("overdue message found")
                                try:
                                    individual_loan_details['overdue_days'] = overdue_days_extract(msg_after_disbursal,
                                                                                                   app)
                                except:
                                    pass
                                individual_loan_details['overdue_check'] += 1
                                ...
                                while k < len(data):
                                    ...
                                    if is_closed(msg_after_overdue, app):
                                        ...
                                        logger.info(
                                            "loan closed because before closing previous loan another disbursal/due message found")
                                        FLAG = True
                                        j = k
                                        break
                                    elif is_overdue(msg_after_overdue, app):
                            ...
                            # ***********************************************************************************************
                                ...
                                individual_loan_details['loan_closed_amount'] = float(
                                    closed_amount_extract(msg_after_disbursal, app))
                                individual_loan_details['messages'].append(str(data['body'][j]))
                                i = j + 1
                                logger.info("loan closed!")
                                break
